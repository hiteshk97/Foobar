...
public class current_user extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.Logout) {
            ...
            startActivity(new Intent(current_user.this,MainActivity.class));
            ParseUser.logOut();
            ...
            startActivity(new Intent(current_user.this,Requests.class));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: {
                    tab_chat tab1 = new tab_chat();
                    return tab1;

                }
                case 1:
                    tab_friends tab2 = new tab_friends();
                    return tab2;
